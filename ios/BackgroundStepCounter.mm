#import "BackgroundStepCounter.h"

@interface BackgroundStepCounter ()
@property (nonatomic, readonly) CMPedometer *pedometer;
@end

@implementation BackgroundStepCounter
...
{
    return std::make_shared<facebook::react::NativeBackgroundStepCounterSpecJSI>(params);
}
#endif
